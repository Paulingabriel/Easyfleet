                    ...
                    <div class="card-body">
                        <form class="form-horizontal form-material mx-3 my-2" action="" method="POST">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="col-md-12">
                                    <input type="text" class="form-control ps-0 form-control-line @error('nom') is-invalid @enderror" value="{{$fournisseurs->nom}}" name="nom" value="{{ old('nom') }}">
                                </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="col-md-12">
                                    <input type="text" class="form-control ps-0 form-control-line @error('type') is-invalid @enderror" name="example-email" id="example-email"  value="{{$fournisseurs->type}}" name="type">
                                </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="col-md-12">
                                    <input type="email" class="form-control ps-0 form-control-line @error('email') is-invalid @enderror" value="{{$fournisseurs->email}}" name="email" value="{{ old('email') }}">
                                </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="col-md-12">
                                    <input type="text" class="form-control ps-0 form-control-line @error('tel') is-invalid @enderror" value="{{$fournisseurs->tel}}" name="tel" value="{{ old('tel') }}">
                                </div>
