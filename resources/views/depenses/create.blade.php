        ...
        <div class="row">
            <div class="col-sm-8 mx-auto">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <form class="form-horizontal form-material mx-3 my-2" action="{{route("depenses/ajouter")}}" method="POST">
                            @csrf
                            ...
                            <div class="form-group mb-4">
                                <label class="col-sm-12">Véhicule</label>
                                <div class="col-sm-12 border-bottom">
                            ...
                            <div class="form-group mb-3">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="date" class="form-control ps-0 form-control-line @error('date1') is-invalid @enderror" name="date1" value="{{ old('date1') }}">
                                        <span class="text-danger">{{ $errors->first('date1') }}</span>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="date" class="col-md-6">Au</label>
                                        <input type="date" class="form-control ps-0 form-control-line @error('date1') is-invalid @enderror" name="date2" value="{{ old('date2') }}">
