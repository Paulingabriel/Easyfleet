                    ...
                    <div class="card-body">
                        <form class="form-horizontal form-material mx-3 my-2" action="" method="POST">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="col-md-12">
                                    <input type="password" class="form-control ps-0 form-control-line  @error('password') is-invalid @enderror"  name="password" value="{{ old('password') }}">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="col-md-6">
                                    <input type="file" class="form-control border border-1" id="inputGroupFile01"  name="image" value="{{ old('image') }}">
                                </div>
                            </div>
                            <div class="form-group mb-3">
