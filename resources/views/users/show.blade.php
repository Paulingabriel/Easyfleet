    ...
    <div class="container px-5 py-5 mb-5" style=" width: 80vw;">
        <div class="row">
            <div class="col-lg-4 shadow py-5 px-5 d-flex justify-content-center" style="background-color: #fff; max-height: 20rem; align-items:center ;">
                    ...
                    <img src="{{asset("../images/".$users->image)}}" alt="" class="rounded-circle" width="230px" height="230px">
            ...
            <div class="col-lg-8">
                <div class="card shadow px-4 py-4 rounded-0 border-0">
                    <div class="card-item mb-3">
                        <h5>Nom</h5>
                        <label for="" class="mt-2">{{$users->nom}}</label>
                    </div>
                    <div class="card-item mb-3">
                        <h5>Email</h5>
                        <label for="" class="mt-3">{{$users->email}}</label>
                    </div>
                    <div class="card-item mb-3">
                        <h5>Mot de passe</h5>
                        <label for="" class="mt-3">{{$users->password}}</label>
                    </div>
                </div>
            </div>
        </div>
