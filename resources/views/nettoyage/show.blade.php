            ...
            <div class="col-lg-6 mx-auto">
                <div class="card shadow px-4 py-4 rounded-0 border-0">
                    <div class="card-item mb-3">
                        <h5>Matricule</h5>
                        <label for="">{{$nettoyages->vehicule->matricule}}</label>
                    </div>
                    <div class="card-item mb-3">
                        <h5>Marque</h5>
                        <label for="">{{$nettoyages->vehicule->marque}}</label>
                    </div>
                    <div class="card-item mb-3">
                        <h5>Rappel Tous/Toutes les</h5>
                        <label for="">{{$nettoyages->number ." ". $nettoyages->rappel}}</label>
                    </div>
                    <div class="card-item mb-3">
                        <h5>Fournisseur</h5>
                        <label for="">{{$nettoyages->fournisseur->nom}}</label>
                    </div>
                </div>
            </div>
        </div>
