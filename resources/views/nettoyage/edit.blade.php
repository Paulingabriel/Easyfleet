                    ...
                    <div class="card-body">
                        <form class="form-horizontal form-material mx-3 my-2" action="" method="POST">
                            ...
                            <div class="form-group mb-3">
                                <input type="hidden" name="id" value="{{$nettoyages->id}}">
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="row">
                                    <div class="col-md-2 pe-0">
                                        <input type="number" class="border form-control form-control-line" name="number" value="{{$nettoyages->number}}">
                                    </div>
                                    <div class="col-md-4">
                                        <select class="border form-select shadow-none form-control-line" name="rappel">
                                            <option selected>{{$nettoyages->rappel}}</option>
