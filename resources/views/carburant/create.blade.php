        ...
        <div class="row">
            <div class="col-sm-8 mx-auto">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <form class="form-horizontal form-material mx-3 my-2" action="{{route("carburant/ajouter")}}" method="POST">
                            @csrf
                            ...
                            <div class="form-group mb-3">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" class="form-control ps-0 form-control-line @error('quantite') is-invalid @enderror" name="quantite" value="{{ old('quantite') }}">
                            ...
                            <div class="form-group mb-3">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" class="form-control ps-0 form-control-line @error('debut') is-invalid @enderror" name="debut" value="{{ old('debut') }}">
                                        <span class="text-danger">{{ $errors->first('debut') }}</span>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="date" class="col-md-6">Kilométrage Fin</label>
                                        <input type="number" class="form-control ps-0 form-control-line @error('fin') is-invalid @enderror" name="fin" value="{{ old('fin') }}">
