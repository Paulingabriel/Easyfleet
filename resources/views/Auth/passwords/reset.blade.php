                    ...
                    <div class="px-4 box-body pt-3">
                        <form action="{{ route('password.update') }}" method="POST">
                            ...
                            <div class="form-input mb-3">
                                <input type="email" placeholder="E-mail" class="form-control  @error('email') is-invalid @enderror" name="email" value="{{ $email ?? old('email') }}" required autocomplete="email" autofocus>
                            ...
                            <div class="form-input mb-5">
                                <input type="password" placeholder="Confirmation du Mot de passe" class="form-control @error('password') is-invalid @enderror" name="password_confirmation" required autocomplete="new-password">
                                <i class="fa-solid fa-unlock-keyhole"></i>
                                <span class="text-danger">{{ $errors->first('password') }}</span>
                            </div>
                            <div class="form-input mb-3">
