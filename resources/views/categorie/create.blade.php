...
<div class="section px-4 py-5">
    <div class="title">
        ...
        <a href="{{route("accueil")}}" class="return">
            <i class="fa-solid fa-arrow-left"></i>
        </a>
        <p><a href="{{route("accueil")}}">Home</a><i class="fa-solid fa-chevron-right"></i>Catégorie</p>
    </div>
                        ...
                        <form class="form-horizontal form-material mx-3 my-2" action="" method="POST">
                            @csrf
                             <div class="form-group mb-3">
                                <label class="col-md-12 mb-0">Intitulé</label>
                                <div class="col-md-12">
                                    <input type="text" class="form-control ps-0 form-control-line @error('name') is-invalid @enderror" name="name">
