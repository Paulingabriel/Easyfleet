                    ...
                    <div class="card-body">
                        <form class="form-horizontal form-material mx-3 my-2" action="" method="POST">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="col-md-12">
                                    <input type="date" class="form-control ps-0 form-control-line @error('date') is-invalid @enderror"  value="{{$maintenances->date}}" name="date" value="{{ old('date') }}">
                                </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="col-md-12">
                                    <textarea class="form-control ps-0 form-control-line @error('description') is-invalid @enderror" row="30" name="description" value="{{ old('description') }}">{{$maintenances->description}}</textarea>
                                </div>
                            ...
                            <div class="form-group mb-3">
                                <div class="col-sm-12 d-flex">
                                    <a href="{{route("maintenances")}}"><button class="btn" type="button" style="background-color:  #009EFB;">Annuler</button></a>
